...
public final class VideoContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.example.tvrecommend";

    // Base of all URIs that will be used to contact the content provider.
    public static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);

    // The content paths.
    public static final String PATH_VIDEO = "dvbchannel";
    ...
    public static final class VideoEntry implements BaseColumns {
        ...
        public static final String COLUMN_CHANNEL_ID = TvContractCompat.PreviewPrograms.COLUMN_CHANNEL_ID;
        // Name of the video table.
        public static final String TABLE_NAME = "dvb";
