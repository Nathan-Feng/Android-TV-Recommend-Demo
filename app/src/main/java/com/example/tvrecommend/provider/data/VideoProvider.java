...
package com.example.tvrecommend.provider.data;
...
public class VideoProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        Log.d("zyf", "VideoProvider onCreate: ");
    ...
    static {
        ...
        sVideosContainingQueryColumns = new String[]{
                ...
                VideoContract.VideoEntry.COLUMN_CHANNEL_ID,
    ...
    private static HashMap<String, String> buildColumnMap() {
        ...
        map.put(VideoContract.VideoEntry.COLUMN_CHANNEL_ID, VideoContract.VideoEntry.COLUMN_CHANNEL_ID);
        ...
        map.put(SearchManager.SUGGEST_COLUMN_INTENT_DATA_ID, VideoContract.VideoEntry.COLUMN_CHANNEL_ID + " AS " +
                SearchManager.SUGGEST_COLUMN_INTENT_DATA_ID);
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        Log.d("zyf", "VideoProvider My Application query: "+uri.toString());
        Cursor retCursor;
        switch (sUriMatcher.match(uri)) {
            case SEARCH_SUGGEST: {
                String rawQuery = "";
                if (selectionArgs != null && selectionArgs.length > 0) {
                    Log.d("zyf", "VideoProvider My Application SEARCH_SUGGEST selectionArgs.length: "+selectionArgs.length);
                    rawQuery = selectionArgs[0];
                }
                Log.d("zyf", "VideoProvider My Application SEARCH_SUGGEST rawQuery: "+rawQuery);
            ...
            case VIDEO: {
                ...
                Log.d("zyf", "VideoProvider My Application VIDEO rawQuery: "+rawQuery);
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        Log.d("zyf", "VideoProvider insert: ");
        final Uri returnUri;
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        Log.d("zyf", "VideoProvider delete: ");
        if (selection == null) {
    ...
    public int update(@NonNull Uri uri, ContentValues values, String selection,
        ...
        Log.d("zyf", "VideoProvider update: ");
        switch (sUriMatcher.match(uri)) {
            case VIDEO: {
    ...
    public int bulkInsert(@NonNull Uri uri, @NonNull ContentValues[] values) {
        Log.d("zyf", "VideoProvider bulkInsert: ");
        switch (sUriMatcher.match(uri)) {
            case VIDEO: {
